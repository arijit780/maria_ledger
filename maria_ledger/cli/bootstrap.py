...
def bootstrap_command(
    ...
    try:
        ...
        # Note: This example assumes 'id', 'name', 'email' schema.
        # A production implementation should dynamically build JSON_OBJECTs
        # for all columns via information_schema queries.
